...
class Decoder2D_Gray(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.convt2 = nn.ConvTranspose2d(32, 3, kernel_size=4, stride=2, padding=1)  # 32x32 -> 64x64
...
class VAEWithResidualFlow_galaxy(nn.Module):
    def __init__(self, latent_dim, hidden_dim, num_flows):
        super(VAEWithResidualFlow_galaxy, self).__init__()
